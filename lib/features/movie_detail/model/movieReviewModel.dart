...
MovieReviewModel movieReviewModelFromJson(String str) => MovieReviewModel.fromJson(json.decode(str));

String movieReviewModelToJson(MovieReviewModel data) => json.encode(data.toJson());
